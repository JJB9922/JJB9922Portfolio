...
export default function LandingCard(){
    return(
        ...
        <div className="flex justify-center items-center py-2">
            ...
            <a href='https://discordapp.com/users/1124274817546326066' target='_blank' className='pl-2 underline hover:animate-pulse text-black dark:text-white'>Discord</a>
          </div>
